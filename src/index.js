...
const mECommerceRoutes = require("./routes/mECommerceRoutes");
const productRoutes = require("./routes/productRoutes");
const eCommerceProductRoutes = require("./routes/eCommerceProductRoutes");
...
app.use("/api/mECommerce", mECommerceRoutes);
app.use("/api/product", productRoutes);
app.use("/api/eCommerceProduct", eCommerceProductRoutes);
